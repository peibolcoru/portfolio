  ...
  return (
    <div className='historia-container'>
      <article>
        ...
        <section className='inicio-foto-container animate__animated animate__bounceInLeft'>
          <p>
            <span className='tab  '></span>Mi trayectoria profesional ha sido un
            viaje diverso y emocionante, marcado por giros inesperados y la
            búsqueda constante de crecimiento personal y profesional.
          </p>
          <img src={foto} alt='' />
        </section>
        <section className=' animate__animated animate__bounceInRight'>
          ...
          <p>
            <span className='tab'></span>Desde una edad temprana, me sumergí en
            el mundo industrial, donde pasé la mayor parte de mi vida laboral.
            Durante estos años, desempeñé roles clave en el control de calidad y
            la inspección de instalaciones. <br />
        ...
        <section className=' animate__animated animate__bounceInLeft '>
          <h3>Explorando el Mundo Audiovisual</h3>
          <p>
            <span className='tab'></span>Paralelamente a mi trabajo en la
            industria, también incursioné en el campo audiovisual. <br />
        ...
        <section className=' animate__animated animate__bounceInRight '>
          ...
          <p>
            <span className='tab'></span>Creo en la preparación continua como
            clave para mantenerme actualizado en un mundo digital en constante
            cambio. <br />
